...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(modern-tab-bar ((t (:inherit (variable-pitch default) :box (:line-width (12 . 8) :style flat-button) :weight light))))
 '(modern-tab-bar-tab ((t (:stipple nil :background " #232136" :family "JetBrains Mono")))))
